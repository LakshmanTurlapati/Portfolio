# Requirements Archive: v4.0 Voice Mode Production

**Archived:** 2026-04-26
**Status:** SHIPPED

Current requirements will be defined by the next milestone. This archive preserves the completed v4.0 requirement scope.
...
| Live Amplify/custom-domain API smoke test | Deferred from v4.0 because `parzival.live` DNS is unavailable; verifier script exists for future execution |
