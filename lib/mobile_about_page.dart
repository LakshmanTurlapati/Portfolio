    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Optionally, add an AppBar or a header here for navigation
            // Example: AppBar with navigation links as buttons
            // This section can be customized based on your design preferences
            ...
            // Optionally, add navigation links here (e.g., horizontal list)
            // For simplicity, I'm omitting them since the sidebar is removed
...
class _TimelineEntryState extends State<TimelineEntry> {
  bool isHovered = false; // Can be removed for mobile

  @override
  Widget build(BuildContext context) {
    // Remove hover effects as they are not applicable on mobile
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(12),
          color: widget.onTap != null ? hoverColor : Colors.transparent,
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            filter: ImageFilter.blur(
              sigmaX: widget.onTap != null ? 10.0 : 0.0,
              sigmaY: widget.onTap != null ? 10.0 : 0.0,
            ),
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  SizedBox(
                    width: MediaQuery.of(context).size.width * 0.3, // Adjusted for mobile
                    child: Text(
                      widget.timeline,
                      style: TextStyle(
                        fontSize: 16,
