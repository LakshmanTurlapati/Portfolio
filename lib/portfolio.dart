...
class _PortfolioPageState extends State<PortfolioPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> displayProjects =
        projects.length > 6 ? projects.sublist(0, 6) : projects;
                          ...
                          children: [
                            if (widget.links.containsKey("Website"))
                              IconButton(
                                ...
                                onPressed: () {
                                  _launchLink(widget.links["Website"]);
                                },
                              ),
                            ...
                            if (widget.links.containsKey("GitHub"))
                              IconButton(
                                ...
                                constraints: const BoxConstraints(),
                                onPressed: () {
                                  _launchLink(widget.links["GitHub"]);
                                },
                              ),
                            const SizedBox(width: 8),
                            if (widget.links.containsKey("Design"))
                              IconButton(
                                ...
                                constraints: const BoxConstraints(),
                                onPressed: () {
                                  _launchLink(widget.links["Design"]);
                                },
                              ),
                          ],
                        ),
